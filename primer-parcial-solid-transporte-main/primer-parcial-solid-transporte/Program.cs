...
namespace primer_parcial_solid_transporte
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<IVehiculoAereo> transporteAereo = new List<IVehiculoAereo>();
            ...
            transporteAereo.Add((IVehiculoAereo)avion1);
